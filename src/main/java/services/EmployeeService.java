...
public class EmployeeService extends ServiceBase {
    ...
    /**
     * 社員番号、パスワードを条件に取得したデータ1件をEmployeeViewのインスタンスで返却する
     * @param code 社員番号
    ...
    public List<String> create(EmployeeView ev, String pepper) {
        ...
        //登録内容のバリデーションを行う
        //第3引数（codeDuplicateCheckFlag）社員番号の重複チェックを実施する
        //第4引数（passwordCheckFlag）パスワードの入力チェックを実施する
    ...
    public List<String> update(EmployeeView ev, String pepper) {
        ...
        //更新内容についてバリデーションを行う
        //第3引数（codeDuplicateCheckFlag）社員番号を更新する場合のみ、重複チェックを実施する
        //第4引数（passwordCheckFlag）パスワードに入力がある場合のみ、入力チェックを実施する
    ...
    /**
     * idを条件に従業員データを論理削除する（delete_flgを1に更新）
     * @param id
     */
